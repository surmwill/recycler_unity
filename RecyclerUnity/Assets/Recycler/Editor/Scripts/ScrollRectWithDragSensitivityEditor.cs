...
namespace RecyclerScrollRect
{
    ...
    /// This class was copied from https://github.com/Unity-Technologies/uGUI to have the same exact source code as a normal ScrollRectEditor, but with one minor addition.
    ...
    public class ScrollRectWithDragSensitivityEditor : Editor
    {
        ...
        SerializedProperty m_DragSensitivity; // Added for RecyclerScrollRect.
        ...
        protected virtual void OnEnable()
        {
            ...
            m_DragSensitivity       = serializedObject.FindProperty("m_DragSensitivity"); // Added for RecyclerScrollRect.
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((ScrollRectWithDragSensitivity)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_DragSensitivity); // Added for RecyclerScrollRect.
