...
namespace RecyclerScrollRect
{
    ...
    /// <summary>
    /// Note for users of RecyclerScrollRect:
    /// This class was copied from https://github.com/Unity-Technologies/uGUI to have the same exact source code as a normal ScrollRect, but with one minor addition.
    /// There is an added "m_dragSensitivity" variable to allow faster drags. Each change is accompanied by a comment "Added for RecyclerScrollRect."
    /// 
    ...
    /// </remarks>
    public class ScrollRectWithDragSensitivity : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
    {
        /// <summary>
        ...
        // Added for RecyclerScrollRect.
        [SerializeField]
        private float m_DragSensitivity = 1.0f;
        
        /// <summary>
        /// Added for RecyclerScrollRect.
        /// The sensitivity to drag events.
        /// </summary>
        /// <remarks>
        /// Higher values indicate higher sensitivity.
        /// </remarks>
        public float dragSensitivity { get { return m_DragSensitivity; } set { m_DragSensitivity = value; } }
        ...
        protected ScrollRectWithDragSensitivity()
        {}
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            pointerDelta *= m_DragSensitivity;  // Added for RecyclerScrollRect.
